...
class ModelConfig:
    def __init__(
        ...
        self.enable_entropy_mask = enable_entropy_mask
        self.entropy_mask_threshold = entropy_mask_threshold
        ...
        self.enable_max_topk = enable_max_topk
        self.gumbel_tau = gumbel_tau
        self.enable_replacement = enable_replacement
        self.enable_gumbel_after_thinking = enable_gumbel_after_thinking
        self.enable_unweighting = enable_unweighting
    ...
    def from_server_args(server_args: ServerArgs, model_path: str = None, **kwargs):
        return ModelConfig(
            ...
            used_topk=server_args.used_topk,
            enable_entropy_mask=server_args.enable_entropy_mask,
            early_stopping_entropy_threshold=server_args.early_stopping_entropy_threshold,
            early_stopping_length_threshold=server_args.early_stopping_length_threshold,
            dirichlet_alpha=server_args.dirichlet_alpha,
            enable_gumbel=server_args.enable_gumbel,
            enable_max_topk=server_args.enable_max_topk,
            gumbel_tau=server_args.gumbel_tau,
            enable_replacement=server_args.enable_replacement,
            enable_gumbel_after_thinking=server_args.enable_gumbel_after_thinking,
            enable_unweighting=server_args.enable_unweighting,
            entropy_mask_threshold=server_args.entropy_mask_threshold,
            think_end_str=server_args.think_end_str,
            after_thinking_temperature=server_args.after_thinking_temperature,
            after_thinking_top_p=server_args.after_thinking_top_p,
            after_thinking_top_k=server_args.after_thinking_top_k,
            after_thinking_min_p=server_args.after_thinking_min_p,
            # ==========
            # end of soft thinking
            # ==========
            **kwargs,
