...
class CudaGraphRunner:
    ...
    def __init__(self, model_runner: ModelRunner):
        ...
        # ==========
        self.enable_soft_thinking = self.model_runner.server_args.enable_soft_thinking
        if self.enable_soft_thinking:
            self.max_topk = self.model_runner.server_args.max_topk
            self.used_topk = self.model_runner.server_args.used_topk
            self.enable_entropy_mask = self.model_runner.server_args.enable_entropy_mask
            self.entropy_mask_threshold = self.model_runner.server_args.entropy_mask_threshold
            self.early_stopping_entropy_threshold = self.model_runner.server_args.early_stopping_entropy_threshold
            self.early_stopping_length_threshold = self.model_runner.server_args.early_stopping_length_threshold
            self.dirichlet_alpha = self.model_runner.server_args.dirichlet_alpha
            self.enable_gumbel = self.model_runner.server_args.enable_gumbel
            self.enable_max_topk = self.model_runner.server_args.enable_max_topk
            self.gumbel_tau = self.model_runner.server_args.gumbel_tau
            self.enable_replacement = self.model_runner.server_args.enable_replacement
            self.enable_gumbel_after_thinking = self.model_runner.server_args.enable_gumbel_after_thinking
            self.enable_unweighting = self.model_runner.server_args.enable_unweighting
            self.after_thinking_temperature = self.model_runner.server_args.after_thinking_temperature
            self.after_thinking_top_p = self.model_runner.server_args.after_thinking_top_p
            self.after_thinking_top_k = self.model_runner.server_args.after_thinking_top_k
            self.after_thinking_min_p = self.model_runner.server_args.after_thinking_min_p
        # ==========
